...
public class GUIItem {
    ...
    ItemStack stormbreakerLockedOntime() {
        ...
        lore.add("");
        lore.add(ChatColor.WHITE + "10 days of ontime is required"); //todo make grab from config for time
    ...
    ItemStack stormbreakerLockedEconomy() { //todo make all gadgets lockable by config
        ItemStack s = new ItemStack(Material.IRON_AXE, 1);
        ItemMeta sm = s.getItemMeta();
        sm.setDisplayName(ChatColor.AQUA + "" + ChatColor.BOLD + "Stormbreaker");
        ArrayList<String> lore = new ArrayList<>();
        ...
        lore.add(ChatColor.DARK_RED + "" + ChatColor.BOLD + "" + ChatColor.ITALIC + "LOCKED");
        lore.add("");
        lore.add(ChatColor.WHITE + "10 days of ontime is required"); //todo make grab from config for price
        lore.add(ChatColor.WHITE + "to unlock this gadget!");
        sm.setLore(lore);
        s.setItemMeta(sm);
        return s;
